            ...
            <div className="header" >
                <div className="header-container">
                    ...
                    <div className="header-navigation">
                        ...
                        <ul className="nav-mobile" ref={menuRef}>
                            <li className="menu-icon-li" ref={menuRef}>
                                <button onClick={handleShow} className="menu-toggle" ref={menuRef}>
                                    ☰
                                </button>
                            </li>
                        </ul>
                    ...
                    <div className="header-menumobile" ref={menuRef}>
                        {showMenu && (
                            <>
